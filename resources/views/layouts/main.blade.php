...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-174263948-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-174263948-2');
    </script>
        ...
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                <li class="mt-2 md:mt-0">
                    <a href="{{ route('home.index') }}" class="hover:text-gray-500"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-tv w-10 mr-2 inline-block" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
